...
def train(args, model):
    ...
    CS_datadir = '/ssd_scratch/cvit/rohit_1202/cityscapes/'
    ...
    savedir = f'/home2/rohit_1202/Rohit_Reprod/MDIL-SS-Reproduction/{args.savedir}'
...
def main(args):
    ...
    # Load Model
   # assert os.path.exists("/home2/rohit_1202/Rohit-Reprod/MDIL-SS-Reproduction/MDIL-SS-main/"+args.model + ".py"), "Error: model definition not found"
